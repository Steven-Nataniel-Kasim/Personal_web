...
export function Lanyard() {
  ...
  return <div className="lanyard-scene"><div className="lanyard-anchor"/><div className="lanyard-ribbon"><span>STEVEN • SOFTWARE TO SILICON •</span></div><button ref={card} className="identity-badge identity-badge-photo" onPointerDown={down} onPointerMove={move} onPointerUp={release} onPointerCancel={release} onKeyDown={(e)=>{if(e.key==="ArrowLeft"||e.key==="ArrowRight"){e.preventDefault();motion.current.vx=e.key==="ArrowLeft"?-12:12;}}} aria-label="Steven identity card. Drag to swing, or use left and right arrow keys."><div className="badge-clip"/><div className="badge-top"><span>INDEPENDENT<br/>EXPLORER</span><b>↗</b></div><div className="badge-photo"><img src="/steven-portrait.png" alt="Steven" width="1086" height="1448" loading="lazy" decoding="async" draggable={false}/></div><h3>STEVEN</h3><p>Informatics student<br/>AI · Architecture · Silicon</p><div className="badge-bottom"><span>ALWAYS LEARNING</span><span>2026</span></div><div className="badge-barcode"/></button><p className="lanyard-hint">DRAG TO EXPLORE ↔</p></div>;
}
